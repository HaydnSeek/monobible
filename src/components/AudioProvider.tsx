...
// import { type any } from '@/lib/episodes'
...
interface PublicPlayerActions {
  ...
  pause: () => void
  toggle: (episode?: any) => void
  seekBy: (amount: number) => void
  seek: (time: number) => void
  playbackRate: (rate: number) => void
  toggleMute: () => void
  isPlaying: (episode?: any) => boolean
}
...
type Action =
  | { type: ActionKind.SET_META; payload: any }
...
export function useAudioPlayer(episode?: any) {
